  ...
  (function ($) {
    ...
    Selectpicker.prototype = {
      ...
      createLi: function () {
        ...
        var liIndex = -1 // increment liIndex whenever a new <li> element is created to ensure liObj is correct
        ...
        this.$element.find('option').each(function (index) {
          ...
          var isOptgroup = $parent[0].tagName === 'OPTGROUP'
          var isOptgroupDisabled = isOptgroup && $parent[0].disabled
          var isDisabled = this.disabled || isOptgroupDisabled
          ...
          if (isOptgroup && $this.data('divider') !== true) {
            ...
            if ($this.index() === 0) { // Is it the first option of the optgroup?
              ...
              var labelSubtext = typeof $parent.data('subtext') !== 'undefined' ? '<small class="text-muted">' + $parent.data('subtext') + '</small>' : ''
              var labelIcon = $parent.data('icon') ? '<span class="' + that.options.iconBase + ' ' + $parent.data('icon') + '"></span> ' : ''
      ...
      liHeight: function (refresh) {
        ...
        var searchHeight = search ? search.offsetHeight : 0
      ...
      setSize: function () {
        ...
        var selectWidth = this.$newElement[0].offsetWidth
        ...
        var selectOffsetTop
        var selectOffsetBot
        var selectOffsetLeft
        var selectOffsetRight
        var getPos = function () {
        ...
        if (this.options.size === 'auto') {
          var getSize = function () {
            var minHeight
            var hasClass = function (className, include) {
            ...
            var optGroup = Array.prototype.filter ? Array.prototype.filter.call(lisVisible, hasClass('dropdown-header', true)) : lisVisible.filter('.dropdown-header')
      ...
      setWidth: function () {
        if (this.options.width === 'auto') {
          ...
          var ulWidth = $selectClone.children('.dropdown-menu').outerWidth()
      ...
      changeAll: function (status) {
        ...
        var $lisVisible = this.$lis.not('.divider, .dropdown-header, .disabled, .hidden')
      ...
      keydown: function (e) {
        ...
        var prevIndex
        var isActive
        var selector = ':not(.disabled, .hidden, .dropdown-header, .divider)'
        var keyCodeMap = {
          32: ' ',
          48: '0',
          49: '1',
