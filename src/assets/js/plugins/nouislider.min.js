...
!(function (a) {
  ...
  function o (a) {
    ...
    var c = (a.compatMode || '') === 'CSS1Compat'
    var d = b ? window.pageXOffset : c ? a.documentElement.scrollLeft : a.body.scrollLeft
    var e = b ? window.pageYOffset : c ? a.documentElement.scrollTop : a.body.scrollTop
    return {
      x: d,
      y: e
    }
  ...
  function B (a, b, c) {
    ...
    var e = Math.ceil(Number(d.toFixed(3)) - 1)
    var f = c.xVal[a] + c.xNumSteps[a] * e
  ...
  function Q (a, b) {
    ...
    var d = b.indexOf('drag') >= 0
    var e = b.indexOf('fixed') >= 0
    var f = b.indexOf('snap') >= 0
    var g = b.indexOf('hover') >= 0
    if (e) {
  ...
  function Y (a, e, g) {
    ...
    function y () {
      ea('update', function (a, b, c, d, f) {
        ra.forEach(function (a) {
          var b = ia[a]
          var d = S(qa, a, 0, !0, !0, !0)
          var g = S(qa, a, 100, !0, !0, !0)
          var h = f[a]
          var i = e.ariaFormat.to(c[a])
    ...
    function A (a, b, c) {
      ...
      var f = {}
      var g = ta.xVal[0]
      var h = ta.xVal[ta.xVal.length - 1]
      var i = !1
      var j = !1
      var k = 0
      return c = d(c.slice().sort(function (a, b) {
        ...
        var h; var l; var m; var n; var o; var p; var q; var r; var s; var t; var u = d
        var v = c[g + 1]
    ...
    function B (a, b, c) {
      ...
      var h = [e.cssClasses.valueNormal, e.cssClasses.valueLarge, e.cssClasses.valueSub]
      var i = [e.cssClasses.markerNormal, e.cssClasses.markerLarge, e.cssClasses.markerSub]
      var j = [e.cssClasses.valueHorizontal, e.cssClasses.valueVertical]
      var m = [e.cssClasses.markerHorizontal, e.cssClasses.markerVertical]
    ...
    function E () {
      ...
      var b = 'offset' + ['Width', 'Height'][e.ort]
    ...
    function G (a, b) {
      var c; var d; var e = a.type.indexOf('touch') === 0
      var f = a.type.indexOf('mouse') === 0
      var g = a.type.indexOf('pointer') === 0
    ...
    function fa (a) {
      var b = a && a.split('.')[0]
      var c = b && a.substring(b.length)
      Object.keys(va).forEach(function (a) {
        var d = a.split('.')[0]
        var e = a.substring(d.length)
    ...
    function ga (a, b) {
      var c = ba()
      var d = ['margin', 'limit', 'padding', 'range', 'animate', 'snap', 'step', 'format']
    ...
    var ha; var ia; var ja; var ka; var la; var ma = p()
    var na = r()
    var oa = na && q()
    var pa = a
    var qa = []
    ...
    var va = {}
    var wa = null
    var xa = a.ownerDocument
    var ya = xa.documentElement
    var za = xa.body
