 ...
 */
if (typeof jQuery === 'undefined') throw new Error("Jasny Bootstrap's JavaScript requires jQuery"); +(function (a) {
  'use strict'
  ...
  b.DEFAULTS = {
    ...
    function b (a, b) {
      if (e.css(b) === 'auto') return a
      if (e.css(a) === 'auto') return b
      var c = parseInt(e.css(a), 10)
      var d = parseInt(e.css(b), 10)
      return c > d ? b : a
    }
    if (this.options.placement !== 'auto') return void (this.placement = this.options.placement)
    this.$element.hasClass('in') || this.$element.css('visiblity', 'hidden !important').addClass('in')
    var c = a(window).width() / this.$element.width()
    var d = a(window).height() / this.$element.height()
    var e = this.$element
    this.placement = c >= d ? b('left', 'right') : b('top', 'bottom'), this.$element.css('visibility') === 'hidden !important' && this.$element.removeClass('in').css('visiblity', '')
    ...
    var b = a('body').width()
    var c = 'padding-' + this.opposite(this.placement)
    ...
    if (!this.state) {
      ...
      if (this.$element.trigger(b), !b.isDefaultPrevented()) {
        ...
        var e = this.opposite(d)
        var f = this.offset(); c.index(this.$element) !== -1 && (a(this.$element).data('offcanvas-style', a(this.$element).attr('style') || ''), this.$element.css(d, -1 * f), this.$element.css(d)), c.addClass('canvas-sliding').each(function () {
          void 0 === a(this).data('offcanvas-style') && a(this).data('offcanvas-style', a(this).attr('style') || ''), a(this).css('position') === 'static' && a(this).css('position', 'relative'), a(this).css(d) !== 'auto' && a(this).css(d) !== '0px' || a(this).css(e) !== 'auto' && a(this).css(e) !== '0px' || a(this).css(d, 0)
        }), this.options.disableScrolling && this.disableScrolling()
        var g = function () {
          this.state == 'slide-in' && (this.state = 'slid', c.removeClass('canvas-sliding').addClass('canvas-slid'), this.$element.trigger('shown.bs.offcanvas'))
        }
    ...
    if (this.state === 'slid') {
      ...
      if (this.$element.trigger(b), !b.isDefaultPrevented()) {
        ...
        var c = a('.canvas-slid')
        var d = (this.placement, -1 * this.offset())
        var e = function () {
          this.state == 'slide-out' && (this.state = null, this.placement = null, this.$element.removeClass('in'), c.removeClass('canvas-sliding'), c.add(this.$element).add('body').each(function () {
    ...
    this.state !== 'slide-in' && this.state !== 'slide-out' && this[this.state === 'slid' ? 'hide' : 'show']()
  ...
  a.fn.rowlink = function (c) {
    ...
    if (a(b.target).closest('.rowlink-skip').length === 0) {
      var c = a(this)
  ...
  var d = window.navigator.appName == 'Microsoft Internet Explorer'
  var e = function (b, d) {
  ...
  e.DEFAULTS = {
    ...
    if (this.$element.length !== 0) {
      if (typeof a === 'number') {
        return b = typeof b === 'number' ? b : a, this.$element.each(function () {
    ...
    return c == 27 ? (this.$element.val(this.focusText), this.caret(0, this.checkVal()), !1) : void 0
  ...
  var c = function (b, c) {
    if (this.$element = a(b), this.$input = this.$element.find(':file'), this.$input.length !== 0) {
  ...
  c.prototype.listen = function () {
    ...
    if (b.stopPropagation(), c.length === 0) return void this.clear()
